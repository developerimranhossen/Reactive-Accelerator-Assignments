...
export default function AddTaskModal({ setShowModal, taskToUpdate, onClose }) {
  ...
  function handleAddEditTask(newTask, e, isAdd) {
    ...
    if (
      ...
      newTask.priority.length === 0
    ) {
      console.log(newTask.tags.length);
      alert("Input field is empty! Please fill up.");
      return;
    }
    ...
    if (isAdd) {
      ...
      console.log(newTask.tags.length);
      if (JSON.stringify([""]) === JSON.stringify(newTask.tags)) {
        newTask.tags.shift();
        console.log(newTask.tags);
      }
      ...
      <form className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/3">
        ...
        <div className="mt-16 flex justify-between lg:mt-20">
          ...
          <button
            ...
            onClick={(e) => handleAddEditTask(task, e, isAdd)}
            disabled={disable}
          >
            {isAdd ? "Create new Task" : "Edit Task"}
          </button>
