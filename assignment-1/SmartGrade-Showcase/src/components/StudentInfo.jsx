...
import studentOneData from "./classOne.json";
import studentTwoData from "./classTwo.json";
          ...
          <div className="container">
            ...
            <div className="max-w-[848px] mx-auto overflow-auto">
              <table className="w-full">
                ...
                <tbody>
                  {/* <!-- className two --> */}
                  <ClassHead head={"className One"} />
                  {studentOneData.map((data) => (
                    <ShowData key={data.id} data={data} />
                  ))}
                  <ClassHead head={"className Two"} />
                  {studentTwoData.map((data) => (
                    <ShowData key={data.id} data={data} />
                  ))}
                </tbody>
              </table>
